...
If you do not want to re-program the FPGA of the RedPitaya, you can use its standard memory map with C code as shown here: https://github.com/lvillasen/RedPitaya-Hello-World-C/ or with Python as shown here: https://github.com/lvillasen/RedPitaya-Hello-World-Python/
